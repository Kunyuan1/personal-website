...
| 2026-09-10 | [Hibernation](./2026-09-10-hibernation.md) | A returning visitor is told what they missed. The rate the ticket was built on had gone 61% stale sitting still — 102 civilisations an hour against the 63.2 it recorded — so the constant now ships with a row that re-measures it. Harness now 43/43 |
