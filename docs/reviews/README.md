...
| 2026-09-10 | [Red Coast](./2026-09-10-red-coast.md) | The contact page becomes a transmission, with a live console reading the same simulation as the hero — and `/contact` still prerenders. Also repaired `check:glyphs`, whose unused-glyph warning could never fire because the declaration counts as a use; it then found 20 orphaned glyphs, and the subset went 97 -> 77 |
